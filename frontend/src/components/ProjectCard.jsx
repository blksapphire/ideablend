...
export default function ProjectCard({ project }) {
  ...
  return (
    <Link
      ...
      className="block rounded-2xl border border-ink/10 dark:border-ink-dark/10 bg-surface dark:bg-surfacedark p-5 hover:border-violet/40 dark:hover:border-violet-dark/40 transition-colors"
    >
      {project.category && (
      ...
      <div className="flex justify-between items-center mt-4 pt-4 border-t border-ink/10 dark:border-ink-dark/10">
